...
export const cardsAPI = {
    ...
    getCardsPack(userId: string, pageCount: string, profileOrPublic: string, page: number, cardPacksTotalCount: number, packName: string  ) {
            return instance.get<CardsResponseType>(`cards/pack`, {params: {
                user_id: (profileOrPublic === 'Profile') ? userId : '', pageCount, page, cardPacksTotalCount,packName,
            }})
    },
